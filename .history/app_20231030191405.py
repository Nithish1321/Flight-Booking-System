...
flight_data = [
    ...
    {"from": "Bangalore", "to": "Chennai", "flight_number": "789", "departure_time": "11:45 AM", "arriving_time": "02:00 PM"},
    {"from": "Bangalore", "to": "Chennai", "flight_number": "101", "departure_time": "12:15 PM", "arriving_time": "03:00 PM"},
    {"from": "Bangalore", "to": "Chennai", "flight_number": "202", "departure_time": "01:30 PM", "arriving_time": "03:45 PM"},
    {"from": "Bangalore", "to": "Chennai", "flight_number": "303", "departure_time": "02:45 PM", "arriving_time": "05:00 PM"},
...
def home():
    if request.method == 'POST':
        ...
        depature=request.form.get('departure')
        return1=request.form.get('return')
        ...
        return render_template('display.html', flights=matching_flights,from_location=from_location,to_location=to_location,depature=depature,return1=return1)
...
def signin():
    ...
    if request.method == 'POST':
        ...
        if result:
            return  re("index.html")
        else:
            return render_template("signin.html",content="Invalid Login!")
